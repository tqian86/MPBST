...
parser.add_argument("--states", "-k", type = int, required = True, help = "the number of states")
parser.add_argument("--iters", "-n", type = int, default = 1000, help = "the number of iterations (maximum iterations when performing stochastic search)")
...
if bool(args.group) ^ bool(args.clusters):
